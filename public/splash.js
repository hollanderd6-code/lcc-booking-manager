...
(function () {
  ...
  var CSS = [
    ...
    '#bh-splash .bh-b{opacity:0;transform-box:fill-box;transform-origin:center;',
    'animation:bhB .55s cubic-bezier(.22,1,.36,1) forwards;animation-delay:.95s}',
    '@keyframes bhB{from{opacity:0;transform:scale(.88)}to{opacity:1;transform:scale(1)}}',
