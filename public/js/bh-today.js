...
(function () {
  ...
  st.textContent = [
    '#bh-today-screen{position:fixed;inset:0;z-index:100004;background:#FBFBFA;',
    ...
    '.bht-eyebrow{font:700 11px/1 "DM Sans",sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#8B8B84;margin-bottom:8px;}',
    '.bht-head h1{font-family:"DM Sans",sans-serif;font-weight:600;font-size:24px;letter-spacing:-.02em;color:#1D1D1B;margin:0;}',
    '.bht-close{flex:none;width:40px;height:40px;border-radius:50%;border:1px solid #EAE9E5;',
    '  background:#fff;color:#5A5A54;font-size:16px;cursor:pointer;}',
    ...
    '.bht-sect-t i{color:#1E6E52;}',
    '.bht-sect-t span{margin-left:auto;background:#EAF1ED;color:#1E6E52;border-radius:7px;padding:2px 9px;font-size:12px;font-weight:600;}',
    '.bht-row{display:flex;align-items:center;gap:12px;background:#fff;border:1px solid #EAE9E5;',
    '  border-radius:12px;padding:14px 15px;margin-bottom:10px;box-shadow:0 1px 2px rgba(29,29,27,.04);}',
    ...
    '.bht-tag.arr{background:#EAF1ED;color:#1E6E52;} .bht-tag.dep{background:#FBF1EA;color:#8A5230;}',
    '.bht-acts{display:flex;gap:8px;flex:none;}',
    '.bht-act{width:40px;height:40px;border-radius:10px;border:1px solid #EAE9E5;',
    '  background:#fff;color:#1E6E52;display:flex;align-items:center;justify-content:center;',
