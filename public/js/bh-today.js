...
(function () {
  ...
  st.textContent = [
    ...
    '.bht-sect-t i{color:#0E3B2E;}',
    '.bht-sect-t span{margin-left:auto;background:#E4EDE8;color:#0E3B2E;border-radius:7px;padding:2px 9px;font-size:12px;font-weight:600;}',
    ...
    '.bht-tag.arr{background:#E4EDE8;color:#0E3B2E;} .bht-tag.dep{background:#FBF1EA;color:#8A5230;}',
    '.bht-acts{display:flex;gap:8px;flex:none;}',
    '.bht-act{width:40px;height:40px;border-radius:10px;border:1px solid #EAE9E5;',
    '  background:#fff;color:#0E3B2E;display:flex;align-items:center;justify-content:center;',
