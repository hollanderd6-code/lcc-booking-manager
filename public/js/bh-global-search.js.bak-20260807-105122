...
(function () {
  ...
  st.textContent = [
    ...
    '.bhgs-item:hover,.bhgs-item.actif{background:rgba(14,59,46,.08);}',
    '.bhgs-ic{flex:none;width:32px;height:32px;border-radius:10px;background:rgba(14,59,46,.1);color:#0E3B2E;display:flex;align-items:center;justify-content:center;font-size:13px;}',
    ...
    '.bhgs-trigger-mobile{width:38px;height:38px;border-radius:50%;border:1px solid rgba(200,184,154,.5);background:#fff;color:#0E3B2E;font-size:14px;cursor:pointer;display:flex;align-items:center;justify-content:center;flex:none;margin-right:8px;}',
