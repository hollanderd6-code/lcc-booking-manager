...
`;
  ...
  function injectMobileTitle() {
    ...
    if (!document.getElementById('bh-mobile-ann-btn')) {
      ...
      annBtn.style.cssText = 'position:absolute;right:80px;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;padding:6px;display:flex;align-items:center;justify-content:center;color:#6B7280;font-size:15px;';
