...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication,
        ...
        let purpleColor = UIColor(red: 0.110, green: 0.098, blue: 0.090, alpha: 1.0) // #1C1917 encre BHGuest
    ...
    func createAndShowSplashScreen() {
        ...
        circleView.backgroundColor = UIColor(red: 0.761, green: 0.255, blue: 0.047, alpha: 1.0) // #C2410C
        ...
        logoLabel.font = UIFont(name: "TimesNewRomanPSMT", size: 68) ?? UIFont.systemFont(ofSize: 68, weight: .regular)
        logoLabel.textColor = .white
        logoLabel.translatesAutoresizingMaskIntoConstraints = false

        let brandLabel = UILabel()
        brandLabel.text = "BHGuest"
        ...
        taglineLabel.text = "Réservez en direct avec votre hôte"
        taglineLabel.textAlignment = .center
        taglineLabel.font = UIFont.systemFont(ofSize: 13, weight: .medium)
        taglineLabel.textColor = UIColor(red: 0.941, green: 0.600, blue: 0.482, alpha: 1.0) // #F0997B
        taglineLabel.alpha = 0
        taglineLabel.translatesAutoresizingMaskIntoConstraints = false

        let spinner = UIActivityIndicatorView(style: .medium)
        spinner.color = UIColor(red: 0.941, green: 0.600, blue: 0.482, alpha: 1.0) // #F0997B
        spinner.alpha = 0
